...
const BaseScreen = ({ navigation, renderChild, header, title, leftButton, rightButton, backTo, logo, paddingTop, paddingHorizontal, Image }) => {
                    ...
                    {leftButton === false ? null :
                        leftButton === 'menu' ?
                            ...
                            <TouchableOpacity style={styles.menuButton}
                                ...
                                <MaterialIcons name="arrow-back-ios" size={25} color='#fff'></MaterialIcons>
                            </TouchableOpacity>
                    }
                    {logo ? <View>{logo}</View>
                        :
